        ...
        if ($execute_query) {               
            if(mysqli_num_rows($execute_query)>0){
                $jsonData_shpiment = mysqli_fetch_all($execute_query, MYSQLI_ASSOC);            
                    ...
                    /* Getting Events Data */
                    $query_events = "SELECT shipment_events.event_id as event_id,shipment_events.date as event_date,shipment_events.remarks as event_remarks,shipment_events.location as event_location,shipment_details.shipment_status as shipment_status FROM shipment_events 
